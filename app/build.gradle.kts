...
android {
    namespace = "com.dungnguyen.pokeworld"
    compileSdk = 34

    defaultConfig {
        applicationId = "com.dungnguyen.pokeworld"
        minSdk = 24
        targetSdk = 33
        versionCode = 1
        versionName = "1.0"
...
dependencies {
    ...
    implementation(project(":features:machines"))
    implementation(project(":features:items"))
    implementation(project(":features:berries"))
